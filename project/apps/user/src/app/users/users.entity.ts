...
import { Email, Password, ImageUrl, Entity } from '@project/libs/shared-types';
...
export class UserEntity implements Entity<UserEntity> {
  ...
  constructor(userData: UserModelProperties) {
  ...
  public fillEntity(userData: UserModelProperties) {
